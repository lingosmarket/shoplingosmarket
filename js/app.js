...
function initialize() {
  	var mapOptions = {
    	zoom: 19,
    	center: new google.maps.LatLng(38.716669,-75.080829),
    	scrollwheel: false,
    	mapTypeControl: true,
        clickable: true,
  	...
  	var myLatLng = new google.maps.LatLng(38.716669,-75.080829);
  	var image = 'images/google-maps/pin.png';

  	var contentString = '<h3>Lingo&#8217s Market</h3>' +
  	'<a href="http://www.google.com/maps?ll=38.716669,-75.080829&z=19&t=h&hl=en-US&gl=US&mapclient=apiv3&cid=16564083420757971981" target="_blank"">149 Rehoboth Ave., Rehoboth Beach, DE, 19971</a>';
